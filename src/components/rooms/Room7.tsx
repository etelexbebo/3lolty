      ...
      <Html center zIndexRange={[100, 0]}>
        ...
        >
          ...
          >
            ...
            <div className="relative flex h-[clamp(140px,22vh,210px)] w-full items-center justify-center overflow-hidden rounded-2xl border border-primary/35 bg-gradient-to-br from-[#1f0a18] to-[#0d0008] shadow-[0_0_26px_rgba(255,182,193,0.18)]">
              {photoOk ? (
                <img
                  src={GIFT.photo}
                  alt={GIFT.photoTitle}
